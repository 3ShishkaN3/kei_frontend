  ...
  <main>
    ...
    <div class="about">
      ...
      <div class="about-content">
        <h2>こんにちは！</h2>
        <h6>
          Рада приветствовать вас на моём образовательном сайте. Здесь вы
          найдёте множество уникальных и полезных уроков по японскому языку,
          которые помогут обучаться быстро и весело! Весь материал был отобран с
          любовью.
        </h6>
        <p>
          Японский язык - это не только способ общения, но и ключ к
          фантастической культуре, традициям и истории Японии. Благодаря языку
          вы сможете понимать не только слова, но и глубинные значения, стоящие
          за ними. Каждый символ, каждое выражение в японском языке несет в себе
          особую энергию и смысл, который открывается лишь тем, кто изучает его.
        </p>
      </div>
    </div>
    <h1>Информация</h1>
